...
public class UserController {
    ...
    public Response<String> login (@ApiParam (value = "包含用户信息，操作信息") @RequestBody LoginVO loginVO) {
    ...
    @LoginAuthorize ()
    public Response<List<User>> getUserByIdAndNick (@ApiParam (value = "关键词") @RequestParam (value = "keyword") String keyword) {
    ...
    public Response<UserVO> getUserVo (@ApiParam (value = "加密验证参数") @RequestHeader (TOKEN) String token,@ApiParam (value = "好友id") @PathVariable (value = "friendId") Integer friendId,@ApiParam (value = "获取方式") @RequestParam (value = "type") String type,@ApiParam (value = "群聊/频道id") @RequestParam (value = "objectId", required = false) Integer objectId) {
        ...
        if (userVO != null) {
            ...
            return Response.createErr (ErrorCode.BIZ_PARAM_ILLEGAL.getCode (),"获取用户信息失败!");
        }
    }
    @ResponseBody
